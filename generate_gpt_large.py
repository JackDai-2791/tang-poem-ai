#!/usr/bin/env python3
"""
Generation script for large Tang poem GPT model.
"""
...
def generate_poem(model, itos, stoi, start_text="春", max_tokens=150, temperature=0.8, top_k=50):
...
def interactive_mode(model, itos, stoi):
    ...
    print("🎭 Tang Poem AI Generator (Large GPT Model)")
    print("=" * 50)
    print("Commands:")
    ...
    while True:
        try:
            ...
            if user_input.lower() in ['quit', 'exit']:
                ...
                print(f"Current parameters: max_tokens=150, temperature=0.8, top_k=50")
                continue
            elif not user_input:
                continue
...
def main():
    parser = argparse.ArgumentParser(description='Generate Tang poems with large GPT model')
