#!/usr/bin/env python3
"""
Prepare script for the medium Tang poem dataset.
"""
...
def prepare_medium_dataset(input_file="tang_poems_medium.txt", output_prefix="tang_medium"):
    """Prepare the medium Tang poem dataset for training."""
