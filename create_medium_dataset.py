#!/usr/bin/env python3
"""
Create a medium subset of Tang poems for fine-tuning.
"""

import random

def create_medium_dataset(input_file="tang_poems_full.txt", output_file="tang_poems_medium.txt", num_poems=2500):
    """Create a medium subset of poems for fine-tuning."""
    ...
    print(f"Created medium dataset with {len(selected_poems)} poems")
