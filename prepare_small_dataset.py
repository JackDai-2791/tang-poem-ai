#!/usr/bin/env python3
"""
Prepare script for the small Tang poem dataset.
"""
...
def prepare_small_dataset(input_file="tang_poems_small.txt", output_prefix="tang_small"):
    """Prepare the small Tang poem dataset for training."""
